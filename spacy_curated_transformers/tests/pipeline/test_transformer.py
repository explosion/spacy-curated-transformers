...
from ..util import make_tempdir, torch_assertclose, xp_assert_equal
...
def test_replace_listeners(cfg_string, listener_name, listener_entrypoint):
    ...
    xp_assert_equal(doc_tensor, pred_tensor)
    ...
    for x, y in zip(
        ...
        for x1, y1 in zip(x, y):
            xp_assert_equal(x1.dataXd, y1.dataXd)
    ...
    with make_tempdir() as d:
        ...
        xp_assert_equal(doc_tensor_trained, pred_tensor)
